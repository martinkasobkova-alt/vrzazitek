/**
 * Loga partnerů převzatá z www.vrzazitek.cz (Webnode CDN).
 * Pořadí odpovídá sekci „Důvěřují nám“ na /vr-pro-firmy.
 */

const CDN = 'https://3f0d647b7d.clvaw-cdnwnd.com/6a3203a6baa9e1dbebb1d79acc84a561';

export type ReferenceLogo = { src: string; alt: string };
